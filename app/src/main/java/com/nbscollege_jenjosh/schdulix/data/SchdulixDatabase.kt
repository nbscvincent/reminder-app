 ...
 */
@Database(entities = [UserProfile::class, ReminderModel::class, AddTimeModel::class, AddTimeTmpModel::class], version = 1, exportSchema = true)
abstract class SchdulixDatabase : RoomDatabase() {
    abstract fun UserProfileDao(): UserProfileDao
    abstract fun ReminderModelDao(): ReminderModelDao
